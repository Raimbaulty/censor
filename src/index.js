...
// 修改 checksum 路由
app.get('/hf/v1/checksum', (req, res) => {
...
// 修改环境变量 checksum 路由
app.get('/hf/v1/env-checksum', (req, res) => {
...
// 修改日志路由
app.get('/hf/v1/logs', (req, res) => {
  const limit = parseInt(req.query.limit) || 100;
  
  const maskedLogs = requestLogs.map(log => ({
    ...log,
    checksum: maskSensitiveInfo(log.checksum),
    authToken: maskSensitiveInfo(log.authToken),
